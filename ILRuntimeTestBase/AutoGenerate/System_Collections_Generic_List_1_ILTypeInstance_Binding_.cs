...
namespace ILRuntime.Runtime.Generated
{
    ...
    unsafe class System_Collections_Generic_List_1_ILTypeInstance_Binding_Enumerator_Binding
    {
        ...
        static void get_Current_0_Neo(ILIntepreter __intp, byte* __frameBase, AutoList __mStack, CLRMethod __method, bool isNewObj, byte* __retDst, int __retRefBase)
        {
            ...
            int __sz_0 = ILIntepreter.GetNeoValueTypeManagedSize(typeof(System.Collections.Generic.List<ILRuntime.Runtime.Intepreter.ILTypeInstance>.Enumerator));
            System.Collections.Generic.List<ILRuntime.Runtime.Intepreter.ILTypeInstance>.Enumerator instance_of_this_method = (System.Collections.Generic.List<ILRuntime.Runtime.Intepreter.ILTypeInstance>.Enumerator)ILIntepreter.ReadNeoValueType(typeof(System.Collections.Generic.List<ILRuntime.Runtime.Intepreter.ILTypeInstance>.Enumerator), __frameBase, ref __curPrim, __sz_0);
